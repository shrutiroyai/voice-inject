...
echo -e "==========================================${NC}"
echo ""
echo -e "${YELLOW}⚠️  First time? Make sure to grant permissions:${NC}"
echo -e "   1. System Settings → Privacy & Security → Input Monitoring"
echo -e "      → Enable your Terminal app"
echo -e "   2. System Settings → Privacy & Security → Microphone"
echo -e "      → Enable your Terminal app"
echo -e "   3. Restart your terminal after granting permissions"
echo ""
